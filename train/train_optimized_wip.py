...
def parse_args():
    ...
    parser.add_argument(
        "disable_image_transforms", default=True, action="store_false", help="Whether or not to resize and crops images"
    )
...
def main():
    ...
    dataset = load_dataset("imagefolder", data_dir="./test/mscoco/00000/")
    ...
    # Preprocessing the datasets.
    if args.disable_image_transforms:
    ...
    def util(image_data):
        try:
            ...
            return Image.new("RGB", size=(256,256))

    def preprocess_train(examples):
        images = [util(image_data) for image_data in examples[image_column]]
